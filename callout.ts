...
/**
 * Callout is wrapped in a function so that, in the future,
 * it's possible to do configuration.
 *
 * import Callout from '@benborgers/callout'
 * const callout = Callout(configObject)
 * ^ export that from a centralized file
 * import { NotionDoc } from '../utils/callout'
 */
